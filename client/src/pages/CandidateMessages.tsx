...
export default function CandidateMessages() {
  ...
  const { data: conversations = [], isLoading, refetch } = trpc.messaging.getCandidateConversations.useQuery(
    undefined,
  ...
  const filteredConversations = conversations.filter((conv) => {
    ...
    // You would need to add agency name to the conversation object
    return true; // Placeholder - would filter by agency name
  });
      ...
      <div className="max-w-7xl mx-auto p-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">
            Connect directly with agencies about job opportunities
          </p>
        </div>
              ...
              {isLoading ? (
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    No conversations yet. Apply to jobs to start messaging agencies!
                  </p>
                </div>
              ) : (
